...
const freelance: Project[] = [
  ...
  },
  {
    ...
    desc: 'Designed and developed a visually engaging digital catalogue for a nail studio to enhance online visibility and client acquisition. Features a curated service showcase with an intuitive UX and an integrated AI-powered chatbot capable of answering client inquiries and streamlining appointment requests.',
